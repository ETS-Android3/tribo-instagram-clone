...
public class EditProfileActivity extends AppCompatActivity {
    ...
    MaterialEditText fullname, username, bio, domain;
    ...
    private void updateProfile(String fullname, String username, String bio, String domain){
